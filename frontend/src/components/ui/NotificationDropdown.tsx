      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed sm:absolute right-4 sm:right-0 top-16 sm:top-auto sm:mt-2 w-[calc(100vw-2rem)] sm:w-96 max-w-md bg-black-900 border border-gold-500/20 rounded-xl shadow-xl overflow-hidden z-[100]"
          >
            {/* Header */}
